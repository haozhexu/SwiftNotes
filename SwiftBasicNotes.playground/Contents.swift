...
// 2. [Types and Operations](#types-and-operations)
...
// 14. [Advanced Operators](#advanced-operators)
// 15. [Patterns](#patterns)
// 16. [Error Handling](#error-handling)
// 17. [Encoding and Decoding](#encoding-and-decoding)
// 18. [A Bit of Everything](#a-bit-of-everything)
...
// A few sample constants and variables declaration

// ```swift
let maximumNumberOfLoginAttempts = 10 // constant
var currentLoginAttempt = 0 // variable
currentLoginAttempt = 1
// // maximumNumberOfLoginAttempts = 11 would generate a compiler error
...
// ### 2.4 Type Safe and Type Inferences
...
// // let lastPi = meaningfulLife + pi won't work: error: binary operator '+' cannot be applied to operands of type 'Int' and 'Double'
// ```
...
// ### 2.10 Compound Assignemnt Operators
...
(3, "apple") < (3, "bird")
// // 3 is equal to 3 and "apple" is less than "bird"
...
// [Comparison operators](#2.11-comparison-operators) let you compare values and get an answer of either `true` or `false`
...
// ### 3.2 Ternary Conditional Operator
...
print("Someone's life is \(onesLife < weightOfFeather ? "lighter than a feather" : "more than a feather").")
// // Someone's life is lighter than a feather.

print("Someone's life is \(anotherOnesLife > weightOfMountain ? "heavier than a mountain" : "less than a mountain").")
...
for currentVersion in 1...totalVersions {
    if currentVersion == versionNumberOfBadLuck {
        print("We skip version \(currentVersion) for avoiding bad luck.")
...
// ```swift
var schoolYear = 3 // try changing it to 1...12
switch schoolYear {
case 1...3:
...
// #### 4.11 Change a parameter directly
...
// ### 4.3 Function that Never Returns
...
// #### 6.1.2 Array with Default Value

// ```swift
var fiveNumbers = Array(repeating: 1.2, count: 3)
// ```

// #### 6.1.3 Adding Two Array Together
...
// #### 6.1.4 Accessing and Modifying Array

// ```swift
var shoppingList = ["Wine", "Coffee"]
...
// shoppingList: ["Wine", "Coffee", "Panado", "Energy Drink"]

shoppingList.insert("Honey", at: 0)
let honey = shoppingList.remove(at: 0)
// ```

// #### 6.1.5 Iterating Over an Array
...
// #### 6.2.1 Hash Value for Set Types
...
if let meaningOf18 = meaningsOfAges["eighteen"] {
    print("The meaning of age 18: \(meaningOf18)")
}
// ```

// #### 6.3.3 Iterating Over a Dictionary
...
// ### 7.1 Inferring Type from Context
...
// define three functions, evaluate unattendence execuse and reason,
...
// ### 9.5 Initializing from Raw Value
...
let nextGenerationExistence = boysAndGirls ^ girlsAndBoys // equals 00010001
// ```
...
// excuted when current scope exists, in reverse order; I guess it is to have a logical way of cleanup from the most recent to the least recent changes; It's like when you go upstairs from level 1 to level 3, and you want to go downstairs, you have to follow the reversed way as when you came up, that is level 3, 2, 1.
